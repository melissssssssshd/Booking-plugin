...
document.getElementById('ib-modal-bg-add-service').onclick = closeAddServiceModal;
...
document.getElementById('ib-modal-bg-edit-service').onclick = closeEditServiceModal;
