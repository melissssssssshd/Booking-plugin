...
window.updateProgressBar = function() {
  console.log("updateProgressBar called - current step:", window.bookingState.step);
  ...
  console.log("Found elements:", steps.length, "steps,", !!progressBar ? "progress bar found" : "no progress bar");
